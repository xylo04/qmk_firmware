...
#      if defined (MCU_STM32F103ZE) || defined (MCU_STM32F103RE) || defined (MCU_STM32F103RD) || defined (MCU_STM32F303CC) || defined(MCU_STM32F072CB)
...
#  ifdef DYNAMIC_KEYMAP_MACRO_ENABLE
...
#  ifdef DYNAMIC_KEYMAP_MACRO_EEPROM_SIZE
